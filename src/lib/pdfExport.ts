...
export async function exportPediatricianPdf(data: {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    ...
    <div class="footer">Generated by Prince Baby Tracker on ${new Date().toLocaleDateString([], { year: 'numeric', month: 'long', day: 'numeric' })}. Parent-logged records — not a clinical document.</div>
  </body></html>`;
